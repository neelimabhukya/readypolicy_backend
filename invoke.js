'use strict';
/*
 * Copyricreaht IBM Corp All Rights Reserved
 *
...
function addDocument(params) {
    ...
    Promise.resolve().then(() => {
        ...
        // changeCarOwner - requires 2 args , ex: args: ['CAR10', 'Barry'],
        // send proposal to endorser
        var str = JSON.stringify(docDetails);
        var request = {
            targets: targets,
            chaincodeId: options.chaincode_id,
            fcn: 'addDocument',
            args: [docDetails.rapidID,str],
            chainId: options.channel_id,
            txId: tx_id
        };
        return channel.sendTransactionProposal(request);
...
function shareDocument(params) {
    ...
    Promise.resolve().then(() => {
        ...
        // changeCarOwner - requires 2 args , ex: args: ['CAR10', 'Barry'],
        // send proposal to endorser
        var str = JSON.stringify(sharedDocs);
        console.log("str",str)
        var request = {
            targets: targets,
            chaincodeId: options.chaincode_id,
            fcn: 'shareDocument',
            args: [sharedDocs.rapidID,str],
            chainId: options.channel_id,
            txId: tx_id
        };
        return channel.sendTransactionProposal(request);
...
function removedocs(params) {
    ...
    Promise.resolve().then(() => {
        ...
        console.log("rapidId",deleteDocs.rapidID)
        console.log("docType",deleteDocs.docs)
        tx_id = client.newTransactionID();
        console.log("Assigning transaction_id: ", tx_id._transaction_id);
        // createCar - requires 5 args, ex: args: ['CAR11', 'Honda', 'Accord', 'Black', 'Tom'],
        // changeCarOwner - requires 2 args , ex: args: ['CAR10', 'Barry'],
        ...
        var request = {
            ...
            chaincodeId: options.chaincode_id,
            fcn: 'removeDocument',
            args: [deleteDocs.rapidID, deleteDocs.docs],
            chainId: options.channel_id,
            txId: tx_id
        };
        return channel.sendTransactionProposal(request);
...
function UserDocs(params) {
    ...
    Promise.resolve().then(() => {
        ...
        // changeCarOwner - requires 2 args , ex: args: ['CAR10', 'Barry'],
        // send proposal to endorser
        var str = JSON.stringify(requestDocs);
        console.log("str",str)
        var requests = {
            targets: targets,
            chaincodeId: options.chaincode_id,
            fcn: 'UserDocs',
            args: [requestDocs.rapidID, str],
            chainId: options.channel_id,
            txId: tx_id
        };
